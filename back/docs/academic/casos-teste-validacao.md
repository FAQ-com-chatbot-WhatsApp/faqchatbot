# TEST PLAN - Clinica GO WhatsApp Bot

**Objective**: To validate all use cases of the application in an organized and chronological manner.

**Total Test Cases**: 120 (UC-001 to UC-120)
**Total Endpoints**: 161 (100% coverage)
...
### Principles
1. Sequential tests: Follow the chronological order of the actual flow
2. Isolated data: Each use case uses specific data
3. Complete validation: Status code, schema, business rules
4. Documentation: Record expected vs. obtained results

### Phase Index

| Phase | Test Cases | Description |
|------|----------------|-----------|
| PHASE 1 | UC-001 to UC-005 | Infrastructure and Authentication |
| PHASE 2 | UC-006 to UC-009 | WAHA Integration (WhatsApp) |
| PHASE 3 | UC-010 to UC-015 | Playbooks (Pre-Approved Messages) |
| PHASE 4 | UC-016 to UC-020 | Messages and Media |
| PHASE 5 | UC-021 to UC-025 | Conversations and Leads |
| PHASE 6 | UC-026 to UC-030 | Gemini AI and Context |
| PHASE 7 | UC-031 to UC-033 | Escalation to Human |
| PHASE 8 | UC-034 to UC-035 | Tags and Filters |
| PHASE 9 | UC-036 to UC-038 | Metrics and Analytics |
| PHASE 10 | UC-039 to UC-040 | Queue Management |
| PHASE 11 | UC-041 to UC-044 | Robustness Tests |
| PHASE 12 | UC-045 to UC-059 | Advanced Security and Authentication |
| PHASE 13 | UC-060 to UC-063 | Advanced Reports |
| PHASE 14 | UC-064 to UC-087 | Handoff and Dashboard |
| PHASE 15 | UC-088 to UC-120 | Complete WAHA (Contacts, Presence, Server) |
...
**Objective**: Validate that all components are working

**Prerequisites**: System initialized (docker-compose up)
...
**Objective**: Create the first administrator user
...
**Validations**:
- Status code: 201
- Password not returned in the response
- UUID valido gerado
- role = "admin"
- is_active = true
