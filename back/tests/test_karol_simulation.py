...
KAROL_MESSAGES = [
    {"time": 0, "from_user": "oi", "expected_bot_behavior": "Saudar + Perguntar nome naturalmente"},
    {
...
""")
    ...
    print(
        "  docker exec postgres psql -U dba -d BotDB -c 'SELECT * FROM conversations WHERE phone_number LIKE \"%98098876%\";'"
    )
