...
def test_create_notification(notification_service, db_session):
...
def test_create_notification_different_types(notification_service, db_session):
...
def test_create_multiple_notifications_for_user(notification_service, db_session):
...
def test_mark_notification_as_read(notification_service, db_session):
...
def test_mark_already_read_notification(notification_service, db_session):
...
def test_get_user_notifications_all(notification_service, db_session):
...
def test_get_user_notifications_unread_only(notification_service, db_session):
...
def test_get_user_notifications_with_limit(notification_service, db_session):
...
def test_get_notifications_for_different_users(notification_service, db_session):
...
def test_get_notifications_empty_result(notification_service, db_session):
...
def test_count_unread_notifications(notification_service, db_session):
...
def test_count_unread_zero(notification_service, db_session):
...
def test_count_unread_no_notifications(notification_service, db_session):
...
def test_notify_new_lead(notification_service, db_session):
    ...
    assert notification is not None
    assert notification.user_id == user_id
    assert notification.notification_type == "NEW_LEAD"
    assert lead_name in notification.message


def test_notify_urgent_message(notification_service, db_session):
    """Test specialized notification for urgent message."""
    user_id = 1333
    conversation_phone = "+5511888888888"
    ...
    assert notification is not None
    assert notification.user_id == user_id
    assert notification.notification_type == "URGENT_MESSAGE"
    assert conversation_phone in notification.message


def test_notify_transfer_received(notification_service, db_session):
...
def test_create_notification_with_long_message(notification_service, db_session):
...
def test_create_notification_empty_title(notification_service, db_session):
...
def test_notification_ordering(notification_service, db_session):
