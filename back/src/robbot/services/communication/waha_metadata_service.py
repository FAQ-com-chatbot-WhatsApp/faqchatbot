    ...
    def get_lid_for_phone(self, phone: str) -> str | None:
        ...
        try:
            with httpx.Client(timeout=10.0) as client:
                ...
                check_url = f"{self.base_url}/api/contacts/check-exists"
                check_params = {"session": self.session, "phone": phone}
                
                check_resp = client.get(check_url, headers=self.headers, params=check_params)
                ...
                lids_url = f"{self.base_url}/api/{self.session}/lids/pn/{normalized_phone}"
                lids_resp = client.get(lids_url, headers=self.headers)
    ...
    def get_all_chats(self, limit: int = 200, offset: int = 0) -> list[str]:
        ...
        try:
            with httpx.Client(timeout=30.0) as client:
                ...
                overview_url = f"{self.base_url}/api/{self.session}/chats/overview"
                params = {"limit": limit, "offset": offset}
                
                resp = client.get(overview_url, headers=self.headers, params=params)
                ...
                chats_url = f"{self.base_url}/api/{self.session}/chats"
                resp = client.get(chats_url, headers=self.headers, params=params)
