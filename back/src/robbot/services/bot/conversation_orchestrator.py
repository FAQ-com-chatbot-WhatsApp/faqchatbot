        ...
        **media_kwargs,
        ...
        try:
            with get_sync_session() as session:
                ...
                if state.is_urgent:
                    await self._trigger_urgent_handoff(session, conversation, state.new_score)
                ...
                # 9. Check Handoff (score-based or intent-based)
                    ...
                    # BUT keep the natural response text generated by the AI
                    await self._trigger_handoff(session, conversation, state.new_score)
